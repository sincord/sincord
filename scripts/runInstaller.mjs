...
const BASE_URL = "https://github.com/Sincord/Sinlotl/releases/latest/download/";
const INSTALLER_PATH_DARWIN = "Sinlotl.app/Contents/MacOS/Sinlotl";
const INSTALLER_APP_DARWIN = "Sinlotl.app";
...
function getFilename() {
    switch (process.platform) {
        case "win32":
            return "SinlotlCli.exe";
        case "darwin":
            switch (process.arch) {
                case "x64":
                    return "Sinlotl-darwin-x64.zip";
                case "arm64":
                    return "Sinlotl-darwin-arm64.zip";
                default:
                    throw new Error("Unsupported macOS architecture: " + process.arch);
            }
        case "linux":
            return "SinlotlCli-linux";
        default:
...
async function ensureBinary() {
    ...
    const res = await fetch(BASE_URL + filename, {
        headers: {
            "User-Agent": "Sincord (https://github.com/Sincord/Sincord)",
            "If-None-Match": etag
        }
    });
...
try {
    execFileSync(installerBin, args, {
        ...
        env: {
            ...
            SINCORD_DIRECTORY: join(BASE_DIR, "dist/desktop"),
